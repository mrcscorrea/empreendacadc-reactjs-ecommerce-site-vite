    ...
    <section className='bg-neutral-900 fixed top-0 bottom-0 right-0 left-0 bg-opacity-70 z-50'>
        <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
            <div className='flex items-center p-4 shadow-md gap-3 justify-between'>
                <h2 className='font-semibold'>Carrinho Ecológico</h2>
                    ...
                    cartItem[0] ? (
                        <>
                            <div className='flex items-center justify-between px-4 py-2 bg-blue-100 text-blue-500 rounded-full'>
                                    <p>Seu desconto</p>
                                    <p>M$ {(notDiscountTotalPrice - totalPrice )}</p>
                            </div>
                                                ...
                                                return(
                                                    <div key={item?._id+"cartItemDisplay"} className='flex  w-full gap-4'>
                                                        ...
                                                        <div className='w-full max-w-sm text-xs'>
                                                            ...
                                                            <p className='font-semibold'>M$ {(pricewithDiscount(item?.productId?.price,item?.productId?.discount))}</p>
                                                        </div>
                                                        <div>
                            ...
                            <div className='bg-white p-4'>
                                ...
                                <div className='flex gap-4 justify-between ml-1'>
                                    ...
                                    <p className='flex items-center gap-2'>{totalQty}x</p>
                                </div>
                        ...
                        <div className='bg-white flex flex-col justify-center items-center'>
                            ...
                            />
                            <Link onClick={close} to={"/"} className='block bg-green-600 px-4 py-2 text-white rounded'>Comprar Agora</Link>
                        </div>
                    )
                }
